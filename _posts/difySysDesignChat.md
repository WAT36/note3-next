...
生成 AI を扱って開発する特性上、以下内容を知っておくと良いです。
...
ここでは問題文を生成するプロンプトを図のように定義します。別のプロンプトにしたい場合はそちらを利用して構いません。
...
今回は Dify を使って個人的なシステムデザイン対策用 AI チャットシステムを作ってみました。システムデザインの対策で利用し、適宜調整しながら良いっものにしていきたいですね。
