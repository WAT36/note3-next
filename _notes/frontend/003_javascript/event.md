---
title: "イベント"
date: "2023-04-16T20:54:41.000Z"
excerpt: 'Javascriptのイベントについて'
tag: ["Web","HTML","Javascript"]
updatedAt: '2023-04-16T20:54:41.000Z'
author:
  name: Tatsuroh Wakasugi
  picture: '/assets/blog/authors/WAT.jpg'
link:
  javascript: ['/assets/note/frontend/javascript/event.js']
---
...
イベントに対応して処理を実行する仕組みを **イベントハンドラ** という。イベントハンドラには処理を1つのみ定義できる。

1つのイベントに処理を複数定義する仕組みもあり、そちらは **イベントリスナ** という。
...
<img src="/assets/note/frontend/javascript/event_ignition.png">


該当のイベントが発火すると、その場所から上へと辿って行き(伝播)、途上でイベントがあった場合はそれも走る。

<img src="/assets/note/frontend/javascript/event_propagation.png">
